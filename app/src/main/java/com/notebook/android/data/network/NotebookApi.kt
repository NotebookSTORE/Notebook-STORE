...
interface NotebookApi {
    ...
    @GET("policies")
    suspend fun policyDataDynamic(@Query("policyId") policyID:Int
    ) : Response<PolicyData>
    ...
    @POST("productfilterby")
    suspend fun productFilterWise(@Body filterData:FilterRequestData
    ...
    * 2 -> Facebook User*/
    ...
    @Headers("Content-Type: application/json")
    @POST("confirmcart")
    suspend fun orderPlacedWithCOD(@Body orderDetails:OrderPaymentDetail
    ) : Response<CFTokenResponse>

    @Headers("Content-Type: application/json")
    @POST("addtowallet")
    suspend fun addWalletAmount(@Body addWalletData:AddWallet
    ) : Response<AddWalletResponse>

    @Headers("Content-Type: application/json")
    @POST("walletamount")
    suspend fun walletAmountGet(@Body walletAmountRaw:WalletAmountRaw
    ) : Response<WalletAmountResponse>

    @Headers("Content-Type: application/json")
    @POST("paymentsuccess")
    suspend fun paymentSaveToDBAfterPayment(@Body paymentRawData:AfterPaymentRawData

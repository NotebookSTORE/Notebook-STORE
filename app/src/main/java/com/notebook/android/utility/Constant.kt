...
object Constant {
    const val MERCHANT_IMAGE_PATH = "http://notebookstore.in/public/uploads/Merchant/"
    const val CATEGORY_IMAGE_PATH = "http://notebookstore.in/public/uploads/category/"
    const val BANNER_IMAGE_PATH = "http://notebookstore.in/public/uploads/Banner/"
    const val SUB_CATEGORY_IMAGE_PATH = "http://notebookstore.in/public/uploads/subcategory/"

    const val BENEFIETS_IMAGE_PATH = "http://notebookstore.in/public/uploads/Benefit/"
    const val LATEST_OFFER_IMAGE_PATH = "http://notebookstore.in/public/uploads/latestoffer/"
    const val LOGO_IMAGE_PATH = "http://notebookstore.in/public/uploads/Logo/"
    const val POLICY_IMAGE_PATH = "http://notebookstore.in/public/uploads/Policy/"
    const val PRODUCT_IMAGE_PATH = "http://notebookstore.in/public/uploads/product/"
    const val PRODUCTIMAGE_IMAGE_PATH = "http://notebookstore.in/public/uploads/productimage/"
    const val  BRAND_IMAGE_PATH= "http://notebookstore.in/public/uploads/brands/"
    const val  MERCHANT_BANNER_IMAGE_PATH= "http://notebookstore.in/public/uploads/Merchantbanner/"
    const val RATING_PRODUCT_IMAGE_PATH = "http://notebookstore.in/public/uploads/rating/"
    const val BASE_IMAGE_PATH = "http://notebookstore.in/public/uploads/"
    const val MERCHANT_BASE_IMAGE_PATH = "http://notebookstore.in/public/uploads/register/"
